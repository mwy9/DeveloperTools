...
{
    public class EncodingBarCode
    {
        #region
        public void GeneratePng(string content, BarcodeFormat barcodeformat, int width, int height, int margin, string alt)
        {
        ...
        public void GenerateSvg(string content, BarcodeFormat barcodeformat, int width, int height, int margin, string alt)
        {
